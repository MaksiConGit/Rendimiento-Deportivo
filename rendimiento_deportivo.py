...
RENDIMIENTO_SALTOS_DIR = "D:\\Maksi\\Escritorio\\Scripts automatizados\\Rendimiento Deportivo\\config\\RENDIMIENTO_SALTOS.txt"
RENDIMIENTO_CAMINAR_DIR = "D:\\Maksi\\Escritorio\\Scripts automatizados\\Rendimiento Deportivo\\config\\RENDIMIENTO_CAMINAR.txt"
...
while True:
    ...
    opcion_inicio = input(Fore.YELLOW + "\n\nBuen día" + Fore.BLUE + "\n\n¿Quieres registrar tu rendimiento deportivo? (" + Fore.GREEN + Style.BRIGHT + "y"
                        + Fore.RESET + Style.RESET_ALL + "/" + Fore.RED + Style.BRIGHT + "n"
                        + Fore.RESET + Style.RESET_ALL + ")\n\n" + Fore.RESET)
